...
def updategh():
    ...
    conn.request("GET", "https://github.com/MataGreek/greekhacking/blob/main/core/version.txt")
    ...
    if repoVersion == currentVersion:os.write("  [*] The script is up to date!\n")
            ...
            conn.request("GET", "https://github.com/MataGreek/greekhacking/blob/main/greekhacking.py")
